...
//    [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(updatePolipo) userInfo:nil repeats:YES];
    ...
    NSDictionary *options = @{GCDWebServerOption_Port:@8090,GCDWebServerOption_BonjourName:@"webserver",GCDWebServerOption_AutomaticallySuspendInBackground:@false};
...
//    NSData *pacData = [[NSData dataWithContentsOfURL:[[NSBundle mainBundle] URLForResource:@"proxy" withExtension:@"pac.gz"]] gunzippedData];
    NSData *pacData = [[NSData dataWithContentsOfURL:[[NSBundle mainBundle] URLForResource:@"gfwlist" withExtension:@"pac.gz"]] gunzippedData];
